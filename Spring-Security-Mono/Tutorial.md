...
#
### Create [LoginRequest.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fmodel%2Frequest%2FLoginRequest.java)
```java
...
#
### Create [JwtResponse.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fmodel%2Fresponse%2FJwtResponse.java)
```java
import lombok.AllArgsConstructor;
import lombok.Getter;
import lombok.NoArgsConstructor;
...
#
### Create [ProfileRepository.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Frepositories%2FProfileRepository.java)
```java
...
```
#
### Create [RefreshTokenRepository.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Frepositories%2FRefreshTokenRepository.java)
```java
import com.alan.security.model.entity.RefreshToken;
import org.springframework.data.jpa.repository.JpaRepository;
import org.springframework.stereotype.Repository;
import org.springframework.transaction.annotation.Transactional;
...
#
### Create [RoleRepository.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Frepositories%2FRoleRepository.java)
```java
...
#
### Create [JwtRefreshResponse.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fmodel%2Fresponse%2FJwtRefreshResponse.java)
```java
import lombok.AllArgsConstructor;
import lombok.Getter;
import lombok.NoArgsConstructor;
...
#
### Create [TokenRefreshRequest.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fmodel%2Frequest%2FTokenRefreshRequest.java)
```java
...
#
### Create [RefreshTokenService.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fservice%2FRefreshTokenService.java)
```java
import com.alan.security.model.entity.RefreshToken;
import com.alan.security.model.entity.User;
import com.alan.security.model.request.TokenRefreshRequest;
import com.alan.security.model.response.JwtRefreshResponse;
import com.alan.security.repositories.RefreshTokenRepository;
import com.alan.security.repositories.UserRepository;
import com.alan.security.service.user.UserDetailsImpl;
import com.alan.security.utils.JwtUtils;
import org.springframework.beans.factory.annotation.Autowired;
...
#
### [ProfileDTO.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fmodel%2Fdto%2FProfileDTO.java) 
```java
...
#
### Create [ProfileMapper.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fmodel%2Fmapper%2FProfileMapper.java)
```java
...
#
### Create [UserMapper.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fmodel%2Fmapper%2FUserMapper.java)
```java
import com.alan.security.model.entity.Role;
import com.alan.security.model.entity.User;
import com.alan.security.model.request.SignupRequest;
...
#
### Create [CheckedRunnable.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Futils%2Fexeption_utils%2FCheckedRunnable.java) and [ExceptionUtils.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Futils%2Fexeption_utils%2FExceptionUtils.java)
```java
@FunctionalInterface
...
#
### Create [AuthService.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fservice%2FAuthService.java)
```java
...
import com.alan.security.model.entity.Role;
import com.alan.security.model.entity.User;
import com.alan.security.model.mapper.ProfileMapper;
import com.alan.security.model.mapper.UserMapper;
import com.alan.security.model.request.LoginRequest;
import com.alan.security.model.request.SignupRequest;
import com.alan.security.model.response.JwtResponse;
import com.alan.security.model.role_enum.ERole;
import com.alan.security.repositories.ProfileRepository;
import com.alan.security.repositories.RoleRepository;
import com.alan.security.repositories.UserRepository;
import com.alan.security.service.user.UserDetailsImpl;
import com.alan.security.utils.JwtUtils;
import com.alan.security.utils.exeption_utils.ExceptionUtils;
import lombok.extern.slf4j.Slf4j;
import org.springframework.beans.factory.annotation.Autowired;
...
#
### Create [AuthController.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fcontroller%2FAuthController.java)
```java
import com.alan.security.model.request.LoginRequest;
import com.alan.security.model.request.SignupRequest;
import com.alan.security.model.request.TokenRefreshRequest;
...
#
### Create [AuthEntryPointJwt.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fconfig%2FAuthEntryPointJwt.java)
```java
...
#
### Create [WebSecurityConfig.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fconfig%2FWebSecurityConfig.java)
```java
...
#
### Create [CommonResponse.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fmodel%2Fresponse%2FCommonResponse.java)
```java
import com.fasterxml.jackson.annotation.JsonInclude;
import lombok.AllArgsConstructor;
import lombok.Builder;
...
#
### Create [ErrorResponse.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fmodel%2Fresponse%2FErrorResponse.java)
```java
import com.fasterxml.jackson.annotation.JsonInclude;
import lombok.AllArgsConstructor;
import lombok.Builder;
...
#
### Create [UserController.java](src%2Fmain%2Fjava%2Fcom%2Falan%2Fsecurity%2Fcontroller%2FUserController.java)
```java
import com.alan.security.constant.Constant;
...
```properties
#Security
security.app.jwtSecret= AlanApp
